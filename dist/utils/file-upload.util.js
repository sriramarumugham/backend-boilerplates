...
const FTP_CREDENTIALS = {
    ...
    directory: process.env.DIRECTORY // FTP directory path to upload images
};
const fileUpload = async (body) => {
    ...
    const client = new basic_ftp_1.Client(); // FTP client instance
    ...
    try {
        ...
        await client.cd(FTP_CREDENTIALS.directory);
